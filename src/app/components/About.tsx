  ...
  const highlights = [
    {
      icon: Brain,
      title: "AI Expertise",
      description: "Deep learning, NLP, and ML algorithms for intelligent solutions.",
    ...
    },
    {
      ...
      description: "Exploring cutting-edge technologies to deliver smarter solutions.",
      ...
      <div className="max-w-6xl mx-auto relative z-10 text-center">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-sm font-medium uppercase tracking-wider text-pink-400">About Me</span>
            <Sparkles className="h-6 w-6 text-pink-300" />
          </div>
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed">
            Passionate about <span className="text-pink-400 font-semibold">AI & modern web development</span>, I build
            <span className="text-pink-400 font-semibold"> scalable, intelligent applications</span> with elegance
            and precision. Focused on delivering solutions that are functional, beautiful, and user-centric.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className={`mx-auto w-16 h-16 rounded-xl flex items-center justify-center text-white mb-6 bg-gradient-to-br ${highlight.gradient} shadow-xl`}>
                    <Icon className="h-8 w-8" />
                  </div>

                  <h3 className="text-xl mb-2 text-white font-semibold">{highlight.title}</h3>
